    ...
    return (
        <section className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
            <h2 className="text-lg font-bold mb-4 flex items-center gap-2">
                ...
                {t('app_which_position')} <span className="text-red-500">*</span>
            </h2>
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="text-center">
                                ...
                                {isPosFull && <span className="text-[10px] text-red-500 font-bold uppercase mt-1 block">{t('app_fully_booked')}</span>}
                            </div>
                        </label>
                    );
                })}
