            ...
            <div className="flex-1 flex flex-col items-center justify-center p-6 text-center relative z-10">
                <div className="relative mb-4 mt-2">
                    <div className="size-24 2xl:size-28 rounded-[2rem] border-[4px] border-white overflow-hidden shadow-xl rotate-3 group-hover:rotate-0 transition-transform duration-500">
                        <img alt="Profile" className="w-full h-full object-cover" src={userInfo.avatarUrl} />
                    </div>
                ...
                <h1 className="text-2xl 2xl:text-3xl font-black text-[#2C3E50] tracking-tight mb-2">{userInfo?.fullName}</h1>
