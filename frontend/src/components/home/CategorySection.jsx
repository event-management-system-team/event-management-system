...
const CategorySection = () => {
    ...
    const { categories, isLoading, isError, errorMessage } = useSelector((state) => state.category);
    ...
    if (isLoading) return <div className="py-12 text-center text-gray-500">Loading Category...</div>;
    if (isError) return <div className="py-12 text-center text-red-500">Error: {errorMessage}</div>;
